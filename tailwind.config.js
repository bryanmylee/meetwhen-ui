...
const shadow = (...params) => params
    .map(([x, y, b, s, c]) => `${x}px ${y}px ${b}px ${s}px ${c}`)
    .join(',');
const shadows = {
  sm: shade => shadow([0, 1, 2, 0, shade]),
  DEFAULT: (shade1, shade2) => shadow([0, 1, 12, 0, shade1], [0, 1, 2, 0, shade2]),
  md: (shade1, shade2) => shadow([0, 4, 18, -1, shade1], [0, 2, 4, -1, shade2]),
  lg: (shade1, shade2) => shadow([0, 10, 45, -3, shade1], [0, 4, 6, -2, shade2]),
  xl: (shade1, shade2) => shadow([0, 20, 25, -5, shade1], [0, 10, 10, -5, shade2]),
};
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: theme => ({
        ...
        primary: shadows.DEFAULT(theme('colors.primary.opacity-60'), theme('colors.primary.opacity-30')),
        'md-primary': shadows.md(theme('colors.primary.opacity-60'), theme('colors.primary.opacity-30')),
        'lg-primary': shadows.lg(theme('colors.primary.opacity-60'), theme('colors.primary.opacity-30')),
        'xl-primary': shadows.xl(theme('colors.primary.opacity-60'), theme('colors.primary.opacity-30')),
      }),
      colors: {
        primary: {
          DEFAULT: 'var(--primary)',
