<script lang="ts">
  ...
  import { getKey } from "@/models/Interval";
  ...
  import type SelectState from "@/models/SelectState";
...
<div class="flex flex-col w-full min-w-24">
  <div
    class="sticky top-0 z-20 flex flex-col items-center justify-center h-16 -mx-2 bg-white"
  >
